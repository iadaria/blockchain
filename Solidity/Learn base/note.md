...
Реализация:
Для одного голосования лучше всего использовать один контракт Иначе усложнит и стоить
Возможность откатить все изменения произведенные в процессе голосование
